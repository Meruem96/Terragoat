...
>* ⚠️ A storage account **must have** a unique world wide name. If you encounter an error like: _(StorageAccountAlreadyExists) The storage account named mydevsecopssa already exists under the subscription._.
>
